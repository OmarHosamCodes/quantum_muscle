# QUANTUM MUSCLE LIMITED CODE REVIEW LICENCE

This licence grants you the rights, and only the rights, set out
below, to access and review Quantum Muscle's code. If you take advantage of
these rights, you accept this licence. If you do not accept the
licence, do not access the code.

## Section 1 -- Definitions

- "code" means the Quantum Muscle's code made available from time, in our sole
...
2. You may provide the code to anyone else and publish excerpts of it
   ...
   licence and that you attribute the code to Omar Hosam Codes.
...
1. This licence does not grant you any rights to use Quantum Muscle's name,
   logo, or trademarks and you must not in any way indicate you are
   authorised to speak on behalf of Omar Hosam Codes.

2. If you issue proceedings in any jurisdiction against Us because
   you consider Us has infringed copyright or any patent right in
...
3. THE CODE IS MADE AVAILABLE "AS-IS" AND WITHOUT ANY EXPRESS OF
   ...
   PARTICULAR, We BEARS NO LIABILITY FOR ANY INTERFERENCE WITH OR
...
2. Questions and comments regarding this licence are welcomed and
   should be addressed to [Omarhosamcodes@gmail.com].
